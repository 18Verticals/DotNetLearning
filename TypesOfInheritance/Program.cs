namespace TypesOfInheritance
{
    ...
    class DerivedClass3 : BaseClass3 // BaseClass3 Parent for DerivedClass3
    {
        public void Dog()
        {
            Console.WriteLine("Dog");
    ...
    class DerivedClass4 : DerivedClass3 // BaseClass3 is grand parent , DerivedClass3 is parent for DerivedClass4
    {
